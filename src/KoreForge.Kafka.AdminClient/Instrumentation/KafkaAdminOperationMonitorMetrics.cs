...
namespace KoreForge.Kafka.AdminClient.Instrumentation;

/// <summary>
/// Bridges <see cref="IKafkaAdminMetrics"/> to <see cref="IOperationMonitor"/> so admin operations automatically emit KoreForge.Metrics events.
/// </summary>
