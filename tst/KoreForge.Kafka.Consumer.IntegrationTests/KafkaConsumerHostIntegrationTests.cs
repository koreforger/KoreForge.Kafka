...
using KoreForge.Kafka.Consumer.IntegrationTests.Infrastructure;
...
namespace KoreForge.Kafka.Consumer.IntegrationTests;
...
public sealed class KafkaConsumerHostIntegrationTests
{
    ...
    private sealed class NoOpSecurityProvider : KoreForge.Kafka.Configuration.Security.IKafkaSecurityProvider
    {
        public void ApplySecurity(ClientConfig clientConfig, string profileName, KafkaSecuritySettings security)
        {
